...
const RegistroPresidente = ({ isOpen, onClose, onPresidenteCreated }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Toast.show({
        type: 'success',
        text1: 'Presidente registrado con éxito',
        position: 'bottom',
      });
    } catch (error) {
      const msg =
    ...
    <Modal visible={isOpen} transparent animationType="slide">
      <View style={styles.modalOverlay}>
        <View style={styles.modalContainer}>
          ...
          <ScrollView>
            ...
            {errors.club_presidente_id && <Text style={styles.errorText}>{errors.club_presidente_id}</Text>}
      ...
      <Modal visible={loading} transparent animationType="fade">
        <View style={styles.loadingOverlay}>
          ...
          <Text style={{ color: '#fff', marginTop: 10 }}>Registrando presidente...</Text>
        </View>
      </Modal>
    </Modal>
  );
